...
export default function StudyLogSection() {
  return (
    <section id="study-log" className="py-40 border-t border-gray-200 text-center">
      ...
      <div className="flex flex-col sm:flex-row justify-center gap-10">
        <a
          ...
          className="group w-64 border border-gray-200 rounded-2xl px-8 py-10 hover:bg-white transition"
        >
