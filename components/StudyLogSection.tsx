...
export default function StudyLogSection() {
  return (
    <section id="study-log" className="py-20 sm:py-32 px-4 sm:px-6 border-t border-gray-200 text-center">
      <h2 className="text-xs tracking-widest text-gray-400 mb-6">STUDY LOG</h2>

      <p className="text-gray-600 mb-8 sm:mb-12 leading-relaxed">
        배운 내용을 기록하고,
        <br />
      ...
      <div className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-6">
        <a
          ...
          className="group w-full max-w-64 sm:w-64 border border-gray-200 rounded-2xl px-6 py-8 sm:px-8 sm:py-10 hover:bg-white transition"
        >
